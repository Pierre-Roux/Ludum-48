-- Niveau
-- ToDo : make generic
mapObject_I1 = require("maps/maphall_ph_v0")
map_I1 = mapObject_I1.layers[1].data

mapObject_I2 = require("maps/maphall_long_ph_v1")
map_I2 = mapObject_I2.layers[1].data

mapObject_H1 = require("maps/map0_ph_v1")
map_H1 = mapObject_H1.layers[1].data
...
-- bug passage de porte
-- bug d'apparition au level suivant 

function initMap()
  
  -- Turn the 1D map generated by Tiled to a 2D map
  twoDimMap_H1 = turnOneDimTableToTwoDimTable(map_H1, 30, 55)

  twoDimMap_L1 = turnOneDimTableToTwoDimTable(map_L1, 30, 55)
  
  twoDimMap_R1 = turnOneDimTableToTwoDimTable(map_R1, 30, 55)
  
  twoDimMap_I1 = turnOneDimTableToTwoDimTable(map_I1, 30, 55)
  twoDimMap_I2 = turnOneDimTableToTwoDimTable(map_I2, 28, 70)
...
function populatePanelTables()
  table.insert(centerPanelsTable, twoDimMap_H1)
  
  table.insert(leftPanelsTable, twoDimMap_L1)
  
  table.insert(rightPanelsTable, twoDimMap_R1)
  
  table.insert(otherPanelsTable, twoDimMap_I1)
  table.insert(otherPanelsTable, twoDimMap_I2)
end
